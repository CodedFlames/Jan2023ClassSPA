...
function afterRender(state) {
  ...
  if (state.view === "Order") {
    document.querySelector("form").addEventListener("submit", event => {
      event.preventDefault(); //tell browser to ignore everything of default action.

      const inputList = event.target.elements; //basically a "this", represents the obj.
      ...
      const requestData = {
        ...
        toppings: toppings //could also equal just toppings because ES6 automatically does : toppings
      };
